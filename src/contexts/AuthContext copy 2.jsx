...
export const AuthProvider = ({ children }) => {
  ...
  const initializeAuth = async () => {
    try {
      ...
      encryptedStorage.cleanupCorruptedData()

      const token = encryptedStorage.getItem('auth_token')
      const userData = encryptedStorage.getItem('user_data')
  ...
  const updateUser = (userData) => {
    ...
    const currentUser = encryptedStorage.getItem("user_data")
    if (currentUser) {
      encryptedStorage.setItem("user_data", { ...currentUser, ...userData })
    }
  }
